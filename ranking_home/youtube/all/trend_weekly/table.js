/* ============================================
   ...
   (async () => {
    ...
    try {
      ...
      thead.innerHTML = `<tr><th>Rank</th><th>Thumb</th><th>Info</th><th>Weekly Views</th></tr>`;
    ...
    /* ============================================
       per-row renderer (Rank / Thumb / Info / Increment(weekly))
       ============================================ */
    function renderRow4cols(item){
      ...
      const inc   = esc(item.increment_d7 ?? "");
